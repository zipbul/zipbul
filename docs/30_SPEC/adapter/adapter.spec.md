...
| ADAPTER-R-005 | MiddlewarePhaseId 정규화 규칙 위반                             | ZIPBUL_ADAPTER_005 | error                    | symbol              | static:ast                        |
| ADAPTER-R-006 | middlewarePhaseOrder/supportedMiddlewarePhases 불일치          | ZIPBUL_ADAPTER_006 | error                    | file                | static:ast                        |
| ADAPTER-R-007 | pipeline phase id 순서/대응 불일치                             | ZIPBUL_ADAPTER_007 | error                    | file                | static:ast                        |
