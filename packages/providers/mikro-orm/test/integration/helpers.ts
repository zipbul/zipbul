 ...
 *   DB_URL_MYSQL=mysql://poc:poc@127.0.0.1:33401/pocdb \
 *   DB_URL_MARIADB=mysql://poc:poc@127.0.0.1:33402/pocdb bun test
 *
...
/** MariaDB speaks the MySQL protocol but is a distinct driver (BunMariaDbDriver). Point this at a
 *  MariaDB server; absent in the default lane → the MariaDB tests skip cleanly. */
export const MARIADB_URL = process.env.DB_URL_MARIADB;
...
export const describeMariadb = MARIADB_URL ? describe : describe.skip;
